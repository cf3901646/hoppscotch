...
data2: {"type":"test2","typeId":"123"}`,
  ...
  {
    command: "curl -sS https://echo.hoppscotch.io/",
    response: makeRESTRequest({
      method: "GET",
      name: "Untitled",
      endpoint: "https://echo.hoppscotch.io/",
  ...
  {
    command: "curl -L -v https://echo.hoppscotch.io/",
    response: makeRESTRequest({
      method: "GET",
      name: "Untitled",
      endpoint: "https://echo.hoppscotch.io/",
  ...
  {
    command: "curl --silent --location https://echo.hoppscotch.io/",
    response: makeRESTRequest({
      method: "GET",
      name: "Untitled",
      endpoint: "https://echo.hoppscotch.io/",
  ...
  {
    command: "curl -I https://echo.hoppscotch.io/",
    response: makeRESTRequest({
      method: "HEAD",
      name: "Untitled",
      endpoint: "https://echo.hoppscotch.io/",
  ...
  {
    command: "curl --head --http2 -4 https://echo.hoppscotch.io/",
    response: makeRESTRequest({
      method: "HEAD",
      name: "Untitled",
      endpoint: "https://echo.hoppscotch.io/",
